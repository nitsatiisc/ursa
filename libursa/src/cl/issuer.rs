...
use cl::amcl_wrapper::field_elem::{FieldElementVector, FieldElement};
use cl::amcl_wrapper::group_elem::{GroupElement, GroupElementVector};
use cl::amcl_wrapper::group_elem_g1::{G1, G1Vector, G1LookupTable};
...
impl Issuer {
    ...
    /// -------------------------------------------------------------------------------------------
    /// Functions to support new revocation based credentials and associated helper functions
    ...
    /// Delegates to appropriate revocation scheme based on revocation
    /// method.
    ...
    fn _gen_credential_context(
        ...
        //return BigNumber::from_dec(rev_idx.unwrap().to_string().as_str());
